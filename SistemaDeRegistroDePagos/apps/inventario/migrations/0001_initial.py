    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('areaMCuadrado', models.DecimalField(decimal_places=6, max_digits=8)),
                ('areaVCuadrada', models.DecimalField(decimal_places=6, max_digits=8)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('precioVenta', models.DecimalField(decimal_places=6, default=0, max_digits=8)),
                ('descuento', models.DecimalField(decimal_places=6, default=0, max_digits=8)),
